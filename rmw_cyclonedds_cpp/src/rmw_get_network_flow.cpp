  ...
  rmw_network_flow_array_t * network_flow_array)
{
  (void) publisher;
  (void) allocator;
  (void) network_flow_array;
  RMW_SET_ERROR_MSG("rmw_publisher_get_network_flow not implemented");
  ...
  rmw_network_flow_array_t * network_flow_array)
{
  ...
  (void) allocator;
  (void) network_flow_array;
  RMW_SET_ERROR_MSG("rmw_subscription_get_network_flow not implemented");
  return RMW_RET_UNSUPPORTED;
}
}  // extern "C"
